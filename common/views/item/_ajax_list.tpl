                    ...
                    <td>
                        <div class="btn-group dropdown">
                            ...
                            <ul class="dropdown-menu pull-right">
                                @if($item->isPending()){
                                    <li><a href="javascript:void(0)" class="approve-now" data-id="@($item->item_id)" title="Approve"><i class="fa fa-thumbs-up" title="Approve"></i> 
                                        @if($item->approved_by){
                                            Confirm Now
                                        } else {
                                            Approve Now
                                ...
                                <li><a href="javascript:void(0);" class="delete" data-id="@($item->item_id)" title="Remove"><i class="fa fa-trash" title="Remove"></i> Delete</a></li>
                            </ul>
                        </div> 
                    </td>
                </tr>
