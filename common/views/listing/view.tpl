...
<div class="container">
    @$form->field($listing, 'account')->textInput(['class' => 'form-control input-sm','value' => $listing->account->company, 'disabled' => true])
    @$form->field($listing, 'title')->textInput(['class' => 'form-control input-sm', 'disabled' => true])
    @$form->field($listing, 'vendor')->textInput(['class' => 'form-control input-sm', 'disabled' => true])
