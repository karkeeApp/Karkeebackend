...
<div class="form-inline">
    ...
    @if (Controller::hasPermission(['member_read', 'member_write'])){
        <a class="btn btn-success btn-sm" href="@(Url::home())sponsor/download" title="Export Record"><i class="fa fa-share-square-o"></i> Export</a>
    }
</div>
        ...
        var contentCallback = function(){
            ...
            $('.set-normal')
                ...
                .bind('click', function(e){
                    ...
                    modConfirm('Become A Normal Membership?', function() {
                        serverProcess({
                            action : 'sponsor/normal',
                            data : 'user_id=' + userId,
                            show_process : true,
                            callback : function(json) {
                                if(json.success){
            ...
            $('.set-silver')
                ...
                .bind('click', function(e){
                    ...
                    modConfirm('Upgrade to Silver Membership?', function() {
                        serverProcess({
                            action : 'sponsor/silver',
                            data : 'user_id=' + userId,
                            show_process : true,
                            callback : function(json) {
                                if(json.success){
            ...
            $('.set-gold')
                ...
                .bind('click', function(e){
                    ...
                    modConfirm('Upgrade to Gold Membership?', function() {
                        serverProcess({
                            action : 'sponsor/gold',
                            data : 'user_id=' + userId,
                            show_process : true,
            ...
            $('.set-platinum')
                ...
                .bind('click', function(e){
                    ...
                    modConfirm('Upgrade to Platinum Membership?', function() {
                        serverProcess({
                            action : 'sponsor/platinum',
                            data : 'user_id=' + userId,
                            show_process : true,
                            callback : function(json) {
                                if(json.success){
                ...
                .bind('click', function(e){
                    ...
                    modConfirm('Upgrade to Diamond Membership?', function() {
                        serverProcess({
                            action : 'sponsor/diamond',
                            data : 'user_id=' + userId,
                            show_process : true,
                            callback : function(json) {
                                if(json.success){
            ...
            $('.remove-sponsor')
                ...
                .bind('click', function(e){
                    ...
                    modConfirm('Are you sure you want to remove this sponsor?', function() {
                        serverProcess({
                            action : 'sponsor/remove-level',
                            data : 'user_id=' + userId,
                            show_process : true,
                            callback : function(json) {
                                if(json.success){
