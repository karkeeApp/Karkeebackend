...
<ul class="nav nav-tabs">
    ...
    <!-- <li><a data-toggle="tab" href="#map"><i class="fa fa-map-marker"></i> Map Coordinates (Vendor Only)</a></li> -->
</ul>
        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="hide">
                    ...
                    @$form->field($userSettingsForm, 'user_id')->textInput()
                </div>
                
                @if(Common::isCpanel()){
                    @$form->field($userSettingsForm, 'carkee_level')->dropDownList(User::levels(), ['class' => 'form-control input-sm'])
                } else {
                    @$form->field($userSettingsForm, 'level')->dropDownList(User::levels(), ['class' => 'form-control input-sm'])
                }
...
(function($) {
    var Settings = function() {
        var bindEvents = function() {
            $('#usersettingsform-resignation_date, #usersettingsform-probation_period').datepicker({
                format : 'yyyy-mm-dd'
            });
            ...
            $('#updateMapCoordinate').bind('click', function(e) {
                ...
                modConfirm('Do you want to proceed?', function() {
                    serverProcess({
                        action:'sponsor/update-coordinate',
