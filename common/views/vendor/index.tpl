...
<div class="form-inline">
   ...
   <button class="btn btn-primary btn-sm" id="search"><i class="fa fa-search"></i></button>
    ...
    @if (Controller::hasPermission(['vendor_read', 'vendor_write'])){
        <a class="btn btn-success btn-sm" href="@(Url::home())vendor/download" title="Export Record"><i class="fa fa-share-square-o"></i> Export</a>
    }
    <a href="@(Url::home())vendor/deleted" class="btn btn-danger btn-sm ">Deleted Records</a>
</div>
