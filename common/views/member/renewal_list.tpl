...
<div class="form-inline">
    ...
    @if (Controller::hasPermission(['member_read', 'member_write'])){
        <a class="btn btn-success btn-sm" href="@(Url::home())member/download-renewal" title="Export Record"><i class="fa fa-share-square-o"></i> Export</a>
    }
</div>
