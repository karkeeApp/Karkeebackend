...
<td>
    <div class="btn-group dropdown">
        ...
        <ul class="dropdown-menu pull-right">
            @if($model->role != 5 && $model->status != 0){
            <li><a href="javascript:void(0);" class="sponsor" data-user_id="@($model->user_id)" title="Sponsor"><i class="fa fa-diamond" ></i> Become Sponsor</a></li>
            }
            <li><a href="@(Url::home())member/@($model->user_id)" title="View Profile"><i class="fa fa-info" title="View"></i> View</a></li>
            @if($model->isVendor()){
                <li><a href="@(Url::home())member/edit/@($model->user_id)" title="Edit Vendor"><i class="fa fa-edit"></i> Edit Vendor</a></li>
            } else {
