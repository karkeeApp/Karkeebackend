...
class VendorController extends Controller
{
    ...
    public function actionList()
    {
        ...
        $data['sort']->route = 'vendor#list/filter';

        if (Common::isClub()) {
            $qry = Common::findUser();    
            $qry->andWhere(['member_type' => User::TYPE_VENDOR]);
            ...
            // if (Common::isClub()) $qry->andWhere(['member_type' => User::TYPE_VENDOR]);
            // else $qry->andWhere(['member_type' => User::TYPE_CARKEE_VENDOR]);
        ...
        return [
            'success' => TRUE,
            'content' => $this->renderPartial('@common/views/vendor/' . $tpl, $data),
        ];
    }
    ...
    public function actionItemlist($id=0)
    {
        ...
        return [
            'success' => TRUE,
            'content' => $this->renderPartial('@common/views/vendor/_ajax_item_list.tpl', $data),
        ];
    }
    ...
    public function actionApprove()
    {
        ...
        if(!$account->isAdministrator()){
            return [
                'success' => FALSE,
                'message'   => "Can't Update Vendor Status! You don't have the required permission to apply changes.",
                'error'   => "Can't Update Vendor Status! You don't have the required permission to apply changes."
            ];
        }
    ...
    public function actionEditVendor()
    {
        ...
        if (!empty($errors)) {
             ...
             * Save user
             */
            $fields = ['vendor_name', 'vendor_description', 'country', 'postal_code', 'unit_no', 'add_1', 'telephone_code', 'telephone_no', 'status', 'mobile_code', 'mobile', 'about', 'founded_date'];
            // $fields = ['email', 'vendor_name', 'vendor_description', 'country', 'postal_code', 'unit_no', 'add_1', 'telephone_code', 'telephone_no', 'status', 'mobile_code', 'mobile', 'about', 'founded_date'];
    ...
    public function actionDeleted()
    {
        ...
        return [
            'success' => TRUE,
            'content' => $this->renderPartial('@common/views/vendor/_ajax_deleted_list.tpl', $data),
        ];
    }
}
