...
class BannerController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        try {
            ...
            return Helper::errorMessage("common/controller/server/BannerController actionCreate: try-catch block: An Error Occurs!");
        }
    }    
    public function actionUpdate()
    {
        ...
        try {
            ...
            $transaction->rollBack();
            // return Helper::errorMessage($e->getMessage());
            return Helper::errorMessage("common/controller/server/BannerController actionUpdate: try-catch block: An Error Occurs!");
        }
    }    
