...
class VendorController extends Controller
{
    ...
    public function actionList()
    {
        ...
        if (Common::isClub()) {
            ...
            $qry->andWhere(['IN','member_type',[User::TYPE_VENDOR, User::TYPE_CARKEE_MEMBER_VENDOR]]);
        }
    ...
    public function actionItemlist($id=0)
    {
        ...
        $keyword = Yii::$app->request->post('type', NULL);
        $type    = Yii::$app->request->post('keyword', NULL);
        $account_id = Yii::$app->request->post('account_id', NULL);
        $status = Yii::$app->request->post('status', NULL);
