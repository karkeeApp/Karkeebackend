...
class UserPaymentForm extends Model
{
    ...
    public function rules()
    {
        return [
            ...
            [['file', 'filename', 'file_logcard'], 'file', 'skipOnEmpty' => TRUE, 'extensions' => 'png, jpg, jpeg, gif', 'maxSize' => 1024 * 1024 * 20, 'on' => ['admin-carkee-remove-ads','admin-carkee-create-payment']],
